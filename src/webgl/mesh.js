...
export default class Mesh {
    ...
    _setGui() {
        ...
        gui.add(parameter, 'distortionRange', 0.0, 1000, 1.0).onChange((value) => {
            this.mesh.material.uniforms.distortionRange.value = value;
        });
        gui.add(parameter, 'noiseRangeX', 0.0, 0.1, 0.001).onChange((value) => {
            this.mesh.material.uniforms.noiseRangeX.value = value;
        });
        gui.add(parameter, 'noiseRangeY', 0.0, 0.1, 0.001).onChange((value) => {
            this.mesh.material.uniforms.noiseRangeY.value = value;
        });
        gui.add(parameter, 'noiseRangeZ', 0.0, 0.1, 0.001).onChange((value) => {
            this.mesh.material.uniforms.noiseRangeY.value = value;
        });
